...
path = '/home/xiaolei/Documents/Github/ML\ Fairness/analysis/overlaps/pos/lib/ark-tweet-nlp-0.3.2/ark-tweet-nlp-0.3.2.jar'
RUN_TAGGER_CMD = "java -XX:ParallelGCThreads=2 -Xmx500m -jar "+path
...
def check_script_is_present(run_tagger_cmd=RUN_TAGGER_CMD):
    ...
    try:
        ...
        print("Caught an OSError, have you specified the correct path to runTagger.sh? We are using " + run_tagger_cmd + ". Exception: " + repr(err))
    return success
...
if __name__ == "__main__":
    ...
    if success:
        print ("Success.")
        tweets = ["12 Tweet Formulas to Get You Started on Twitter: http://hub.am/Sgsvt5 #twittertips by @HubSpot",
                                      "important but often forgotten. - RT @mvolpe \"10 Things Great Marketers Do Every Day\" http://hub.am/1m6RPK4 by @kellykranz"]
        print ("Now pass in two messages, get a list of tuples back: ", str(tweets) )
